...
public class XmlAddressBookStorageTest {
    ...
    @Test
    public void readAddressBook_invalidRestaurantAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidRestaurantAddressBook.xml");
    }

    @Test
    public void readAddressBook_invalidAndValidRestaurantAddressBook_throwDataConversionException() throws Exception {
        thrown.expect(DataConversionException.class);
        readAddressBook("invalidAndValidRestaurantAddressBook.xml");
    }
    ...
    public void readAndSaveAddressBook_allInOrder_success() throws Exception {
        ...
        original.removeRestaurant(RESTAURANT_A);
        xmlAddressBookStorage.saveAddressBook(original, filePath);
