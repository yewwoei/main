...
public class HelpCommandSystemTest extends AddressBookSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectRestaurantCommand.COMMAND_WORD + " " + INDEX_FIRST_RESTAURANT.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_RESTAURANT.getOneBased());
