...
|`* * *` |Sociable person |Add people to my list of friends |So that they will be in my address book

|`* * *` |Sociable person |Add many friends to a group |So that we have an exclusive group to start food jios in or keep track of finances
...
|`* * *` |Person who always eat as a group |Know how much should each of us pay |We can clarify the debt

|`* * *` |Person who always eat as a group |Mark down our payment and balance them off |Reduce the trouble of paying off each time
...
|`* *` |Paranoid person |Choose to accept or delete friend requests |I can better protect my privacy

|`* *` |Paranoid person |Choose which group requests to accept and delete |I can better protect my privacy
...
|`* *` |Person who owes other and is also owed |Simplify my debts |Save the hassle of paying and collecting from multiple people
...
|`*` |Sociable person |Get recommendations for friends based on mutual friends |So that I can have more friends
