...
Allows a user to view his own profile in the Makan Book. The browser panel will then contains the user's details,
the reviews he's written and the list of friends he has.
