...
It is not just a restaurant list, more importantly is that the Makan book allows user to create personal account, which
 ...
 to join his dinner. Or find a good restaurant base on other users' rating and review. After his meal, user can
 even rate and write review for the restaurant, which everyone can see, to share his experience. Also, if the user is
