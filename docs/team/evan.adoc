...
* *Minor enhancement*: added a displayProfile command that allows the user to view all the data that is related to him. This includes his own personal information, the reviews he has made, friends and more.
